...
class BitchAssRecTable extends Spine.Controller
  elements:
    'tbody': 'here'
  ...
  addAll: =>
    @here.empty()
    bitchAssRecs = AssignmentRecord.bitchRecords()
    @log bitchAssRecs
    @addOne(assRec) for assRec in bitchAssRecs


module.exports = BitchAssRecTable
